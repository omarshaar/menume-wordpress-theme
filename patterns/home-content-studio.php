	...
	<div class="wp-block-group alignwide menume-content-studio__inner">
		...
		<div class="wp-block-group menume-content-studio__visual">
			...
			<div class="mcs" aria-hidden="true">
				<div class="mcs__cursor">
					<svg class="mcs__cursor-icon" viewBox="0 0 24 24" width="26" height="26">
						<path d="M5.5 3.21V20.79L10.29 16.29L13.29 21.51L15.9 20.01L12.9 14.79L18.79 14.79L5.5 3.21Z" fill="#111111" stroke="#fff" stroke-width="1.4" stroke-linejoin="round"/>
					</svg>
					<span class="mcs__cursor-ripple"></span>
				</div>
				...
				<div class="mcs__panel mcs__panel--platforms">
					...
					<div class="mcs__platform-row">
						<div class="mcs__platform mcs__platform--ig">
							<svg viewBox="0 0 24 24" width="26" height="26"><rect x="3" y="3" width="18" height="18" rx="5" fill="none" stroke="currentColor" stroke-width="1.8"/><circle cx="12" cy="12" r="4" fill="none" stroke="currentColor" stroke-width="1.8"/><circle cx="17.4" cy="6.6" r="1.1" fill="currentColor"/></svg>
						</div>
						<div class="mcs__platform mcs__platform--fb">
							<svg viewBox="0 0 24 24" width="26" height="26"><path fill="currentColor" d="M15 8.5h2.5V5H15c-2.5 0-4 1.6-4 4.2V11H8.5v3.5H11V21h3.5v-6.5h2.7l.5-3.5h-3.2V9.4c0-.6.3-.9 1.3-.9z"/></svg>
						</div>
					</div>
				</div>

				<div class="mcs__panel mcs__panel--generating">
					<div class="mcs__gen-icon">✦</div>
					<div class="mcs__gen-spinner-wrap">
						<div class="mcs__spinner"></div>
					</div>
					<div class="mcs__gen-title"><?php echo esc_html__( 'KI erstellt deinen Beitrag', 'menume' ); ?></div>
					<div class="mcs__gen-desc"><?php echo esc_html__( 'Die KI gestaltet das Bild, passt die Markenidentität an und ordnet den Text – für einen fertigen, veröffentlichungsbereiten Beitrag.', 'menume' ); ?></div>
					<div class="mcs__gen-note"><span class="mcs__gen-dot"></span><?php echo esc_html__( 'Bitte warten – die Bilderstellung kann etwas dauern', 'menume' ); ?></div>
				</div>

				<div class="mcs__panel mcs__panel--result">
					<div class="mcs__result-card">
						<div class="mcs__result-media">
							<img src="<?php echo esc_url( get_theme_file_uri( '/assets/images/food-enhancer/truffle-pasta-studio.jpg' ) ); ?>" alt="<?php echo esc_attr__( 'Trüffel-Pasta', 'menume' ); ?>" />
							<span class="mcs__result-caption"><?php echo esc_html__( '🍝 Trüffel-Pasta', 'menume' ); ?></span>
							<span class="mcs__result-likes">♥ 128</span>
						</div>
