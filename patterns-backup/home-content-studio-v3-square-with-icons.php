...
<section class="wp-block-group alignfull menume-content-studio" id="content-studio">
	...
	<div class="wp-block-group alignwide menume-content-studio__inner">
		...
		<div class="wp-block-group menume-content-studio__visual">
			<!-- wp:html -->
			<svg class="menume-content-studio__illustration" viewBox="0 0 480 480" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="<?php echo esc_attr__( 'Content wächst mit KI', 'menume' ); ?>">
				<defs>
					...
					<radialGradient id="csGlowB" cx="0.5" cy="0.5" r="0.5">
						<stop offset="0" stop-color="#12B8A6" stop-opacity="0.28"/>
						<stop offset="1" stop-color="#12B8A6" stop-opacity="0"/>
					</radialGradient>
				</defs>

				<circle cx="90" cy="100" r="140" fill="url(#csGlowA)"/>
				<circle cx="390" cy="380" r="150" fill="url(#csGlowB)"/>

				<path d="M50,404 C150,404 150,296 228,296 C298,296 298,178 398,96" stroke="url(#csGradC)" stroke-width="5" stroke-linecap="round" stroke-dasharray="1 16" opacity="0.55"/>

				<circle cx="150" cy="352" r="6" fill="#635BFF" opacity="0.5"/>
				<circle cx="330" cy="184" r="5" fill="#12B8A6" opacity="0.6"/>

				<g>
					<rect x="28" y="364" width="80" height="80" rx="22" fill="url(#csGradA)"/>
					<rect x="46" y="392" width="34" height="6" rx="3" fill="#fff" opacity="0.85"/>
					<rect x="46" y="404" width="24" height="6" rx="3" fill="#fff" opacity="0.55"/>
				</g>

				<g>
					<rect x="192" y="248" width="96" height="96" rx="26" fill="url(#csGradB)"/>
					<rect x="213" y="281" width="42" height="7" rx="3.5" fill="#fff" opacity="0.85"/>
					<rect x="213" y="295" width="28" height="7" rx="3.5" fill="#fff" opacity="0.55"/>
				</g>

				<g>
					<rect x="312" y="72" width="118" height="118" rx="30" fill="url(#csGradC)"/>
					<rect x="339" y="114" width="52" height="8" rx="4" fill="#fff" opacity="0.9"/>
					<rect x="339" y="130" width="34" height="8" rx="4" fill="#fff" opacity="0.6"/>
					<rect x="339" y="146" width="42" height="8" rx="4" fill="#fff" opacity="0.4"/>
				</g>

				<g transform="translate(392,42)">
					<path d="M18 0 L22 14 L36 18 L22 22 L18 36 L14 22 L0 18 L14 14 Z" fill="url(#csGradC)"/>
				</g>
				<g transform="translate(2,300) scale(0.55)">
					<path d="M18 0 L22 14 L36 18 L22 22 L18 36 L14 22 L0 18 L14 14 Z" fill="#12B8A6" opacity="0.7"/>
				</g>

				<g transform="translate(76,348)">
